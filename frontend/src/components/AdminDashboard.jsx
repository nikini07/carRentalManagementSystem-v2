...
const AdminDashboard = ({ cars, setCars, customers, setCustomers, bookings, setBookings, saveCar, saveCustomer, saveBooking, generateCustomerID, generateBookingID, dateLessThan, deleteCar, deleteCustomer, deleteBooking }) => {
  ...
  return (
    <div className="container mx-auto p-4 bg-gray-900 min-h-screen text-white font-sans">
      <h1 className="text-2xl font-bold mb-6 text-center text-gray-100">Admin Dashboard</h1>
      {view === 'menu' && (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          {[
            ...
            <button
              key={item.view}
              className="bg-lime-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-lime-700 focus:ring-2 focus:ring-lime-500 focus:outline-none transition-colors duration-150"
      ...
      {view === 'addCar' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Add New Car</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={field.name} className="flex flex-col">
                <label className="text-sm font-medium mb-1 text-gray-200">{field.placeholder}</label>
                <input
                  type={field.type}
                  name={field.name}
                  ...
                  className="bg-gray-800 text-white border border-gray-600 p-2 rounded-md text-sm focus:ring-2 focus:ring-lime-500 focus:border-lime-500"
                />
              </div>
            ))}
          </div>
          <div className="flex justify-end space-x-3 mt-4">
            <button
              className="bg-gray-700 text-white px-4 py-2 rounded-md hover:bg-gray-600 disabled:opacity-50 transition-colors duration-150"
            ...
            <button
              className="bg-lime-600 text-white px-4 py-2 rounded-md hover:bg-lime-700 disabled:opacity-50 transition-colors duration-150"
              onClick={addCar}
              disabled={isLoading}
            >
      ...
      {view === 'addCustomer' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Add New Customer</h2>
          <div className="space-y-3">
            {[
      ...
      {view === 'addBooking' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Add New Booking</h2>
          <div className="space-y-3">
            {[
      ...
      {view === 'updateCar' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Update Car</h2>
          <div className="space-y-3">
            <div className="flex flex-col">
              <label className="text-sm font-medium mb-1 text-gray-200">Car ID</label>
              <input
                type="text"
                name="updateCarID"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-medium mb-1 text-gray-200">Field to Update</label>
              <select
                name="updateCarField"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-medium mb-1 text-gray-200">New Value</label>
              <input
                type="text"
                name="updateCarValue"
      ...
      {view === 'deleteCar' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Delete Car</h2>
          <div className="flex flex-col">
            <label className="text-sm font-medium mb-1 text-gray-200">Car ID</label>
            <input
              type="text"
          ...
          <div className="flex justify-end space-x-3 mt-4">
            ...
            <button
              className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 disabled:opacity-50 transition-colors duration-150"
      ...
      {view === 'updateCustomer' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Update Customer</h2>
          <div className="space-y-3">
            <div className="flex flex-col">
              <label className="text-sm font-medium mb-1 text-gray-200">Customer ID</label>
              <input
                type="text"
      ...
      {view === 'deleteCustomer' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Delete Customer</h2>
          <div className="flex flex-col">
            <label className="text-sm font-medium mb-1 text-gray-200">Customer ID</label>
            <input
              type="text"
      ...
      {view === 'updateBooking' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Update Booking</h2>
          <div className="space-y-3">
            <div className="flex flex-col">
              <label className="text-sm font-medium mb-1 text-gray-200">Booking ID</label>
              <input
                type="text"
            ...
            {formData.updateBookingField === 'startDate' || formData.updateBookingField === 'endDate' ? (
              <div className="space-y-3">
                <div className="flex flex-col">
                  <label className="text-sm font-medium mb-1 text-gray-200">{formData.updateBookingField === 'startDate' ? 'Start Day' : 'End Day'}</label>
                  <input
                    type="number"
                ...
                <div className="flex flex-col">
                  <label className="text-sm font-medium mb-1 text-gray-200">{formData.updateBookingField === 'startDate' ? 'Start Month' : 'End Month'}</label>
                  <input
                    type="number"
                ...
                <div className="flex flex-col">
                  <label className="text-sm font-medium mb-1 text-gray-200">{formData.updateBookingField === 'startDate' ? 'Start Year' : 'End Year'}</label>
                  <input
                    type="number"
      ...
      {view === 'deleteBooking' && (
        <div className="max-w-md mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">Delete Booking</h2>
          <div className="flex flex-col">
            <label className="text-sm font-medium mb-1 text-gray-200">Booking ID</label>
            <input
              type="text"
      ...
      {view === 'viewCars' && (
        <div className="max-w-4xl mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">All Cars</h2>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-lime-600 text-white">
                  ...
                  <th className="p-2 text-left font-semibold text-sm">Type</th>
                  <th className="p-2 text-left font-semibold text-sm">Year</th>
                  <th className="p-2 text-left font-semibold text-sm">Capacity</th>
                  <th className="p-2 text-left font-semibold text-sm">Rate/Day</th>
                  <th className="p-2 text-left font-semibold text-sm">Available</th>
                </tr>
              </thead>
              <tbody>
                {cars.map((car, index) => (
                  <tr key={car.id} className={index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-850'}>
                    <td className="p-2 text-white text-sm">{car.id}</td>
                    <td className="p-2 text-white text-sm">{car.brand}</td>
                    <td className="p-2 text-white text-sm">{car.model}</td>
                    <td className="p-2 text-white text-sm">{car.type}</td>
                    <td className="p-2 text-white text-sm">{car.year}</td>
                    <td className="p-2 text-white text-sm">{car.capacity}</td>
                    <td className="p-2 text-white text-sm">${car.rate.toFixed(2)}</td>
                    <td className="p-2">
                      <span className={`px-2 py-1 rounded-full text-xs ${car.available ? 'bg-lime-600 text-white' : 'bg-red-600 text-white'}`}>
          ...
          <div className="flex justify-end mt-4">
            <button
              className="bg-gray-700 text-white px-4 py-2 rounded-md hover:bg-gray-600 transition-colors duration-150"
              onClick={() => setView('menu')}
            >
              Back
            </button>
      ...
      {view === 'viewCustomers' && (
        <div className="max-w-4xl mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">All Customers</h2>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-lime-600 text-white">
                  ...
                  <th className="p-2 text-left font-semibold text-sm">Contact</th>
                </tr>
              </thead>
              <tbody>
                {customers.map((cust, index) => (
                  <tr key={cust.id} className={index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-850'}>
                    <td className="p-2 text-white text-sm">{cust.id}</td>
                    <td className="p-2 text-white text-sm">{cust.name}</td>
                    <td className="p-2 text-white text-sm">{cust.license}</td>
                    <td className="p-2 text-white text-sm">{cust.contact}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {view === 'viewBookings' && (
        <div className="max-w-4xl mx-auto bg-gray-800 p-6 rounded-md shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-gray-100">All Bookings</h2>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-lime-600 text-white">
                  ...
                  <th className="p-2 text-left font-semibold text-sm">Start Date</th>
                  <th className="p-2 text-left font-semibold text-sm">End Date</th>
                </tr>
              </thead>
              <tbody>
                {bookings.map((bk, index) => (
                  <tr key={bk.bookingID} className={index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-850'}>
                    <td className="p-2 text-white text-sm">{bk.bookingID}</td>
                    <td className="p-2 text-white text-sm">{bk.carID}</td>
                    <td className="p-2 text-white text-sm">{bk.customerID}</td>
                    <td className="p-2 text-white text-sm">{`${bk.startDate.day}-${bk.startDate.month}-${bk.startDate.year}`}</td>
                    <td className="p-2 text-white text-sm">{`${bk.endDate.day}-${bk.endDate.month}-${bk.endDate.year}`}</td>
                  </tr>
                ))}
              </tbody>
            </table>
